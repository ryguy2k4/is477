...
JOIN Airline1_Schedule as b ON a.FlightId = b.FlightId
JOIN Airport3_Arrivals as c ON b.FlightNumber = c.FlightNumber AND a.ArrivalDate = c.Scheduled AND 'A1' = c.Airline AND 'EWR' = b.ArrivalAirport
;